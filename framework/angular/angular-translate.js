 ...
 */
angular.module('angular-translate', ['ng']).run([
  '$translate',
  function ($translate) {
...
angular.module('angular-translate').provider('$translate', [
  '$STORAGE_KEY',
...
angular.module('angular-translate').factory('$translateDefaultInterpolation', [
  '$interpolate',
...
angular.module('angular-translate').directive('translate', [
  '$translate',
  '$q',
  '$interpolate',
  '$compile',
...
angular.module('angular-translate').directive('translateCloak', [
  '$rootScope',
  '$translate',
...
angular.module('angular-translate').filter('translate', [
  '$parse',
  '$translate',
