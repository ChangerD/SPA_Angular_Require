...
(function() {
  ...
  var CouchPotato = function(angular) {
     ...
     * <pre>
     * var myModule = angular.module('myApp', ['myOtherDep', 'angular-couch-potato']);
     * </pre>
     *
     * See also the {@link angular-couch-potato.$couchPotatoProvider
     * $couchPotatoProvider} documentation.
     */
    var module = angular.module('angular-couch-potato', ['ng']);
    ...
    function CouchPotatoProvider(
       ...
       *
       * @ngdoc object
       * @name angular-couch-potato.$couchPotato
       *
       * @description
       *
       * ==
       ...
       * {@link angular-couch-potato.$couchPotatoProvider $couchPotatoProvider}
     ...
     *
     * @ngdoc object
     * @name angular-couch-potato.$couchPotatoProvider
     *
     * @description
     * Injects and retains references to providers that will be used
     * by the {@link angular-couch-potato.$couchPotato $couchPotato service}
     * at run-time.
     *
     ...
     * </pre>
     *
     * See the {@link angular-couch-potato couch-potato module documentation} to learn
